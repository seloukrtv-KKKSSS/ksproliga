...
.candidate { position: relative; display: grid; grid-template-columns: 22px minmax(0, 1fr) 58px; align-items: center; gap: 8px; height: 60px; overflow: hidden; padding: 8px 9px 12px; border: 1px solid #293e54; border-radius: 8px; background: #112337; contain: layout paint; }
...
@media (max-width: 370px) {
  .stage { padding: 8px; }
  .widget { padding: 12px; }
  .candidate { grid-template-columns: 17px minmax(0, 1fr) 51px; gap: 6px; padding-right: 7px; padding-left: 7px; }
  .name { font-size: 12px; }
